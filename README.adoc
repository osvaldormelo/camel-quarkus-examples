...
9. camel-quarkus-soap-kafka - An example originated from the need to use a SOAP service in Camel to replace a legacy SOAP service with minimal impact on existing applications.
== Useful Links
