# camel-quarkus-artemis-consumer Project

This project uses Quarkus, the Supersonic Subatomic Java Framework. This is a project for a proof of concept using a websocket connection for an AMQ Broker(Apache Artemis) queue. This module is a consumer that complements the project camel-quarkus-ws-to-events or camel-quarkus-ws-to-events-artemis. 
