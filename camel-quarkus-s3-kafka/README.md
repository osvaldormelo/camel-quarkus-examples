...
You can then execute your native executable with: `./target/camel-quarkus-s3-kafka-1.0.0-SNAPSHOT-runner`
...
- Camel Avro ([guide](https://access.redhat.com/documentation/en-us/red_hat_build_of_apache_camel/4.4/html/red_hat_build_of_apache_camel_for_quarkus_reference/camel-quarkus-extensions-reference#extensions-avro)): Serialize and deserialize messages using Apache Avro binary data format
