...
public class ConsumerRouteBuilder extends RouteBuilder{
    ...
    public void configure() throws Exception {
        ...
        .to("mongodb:mongoBean?hosts="+ MONGO_DB_HOST +"&username="+MONGO_DB_USERNAME+"&authenticationDatabase="+MONGO_DB_DATABASE+"&password="+MONGO_DB_PASSWORD+"&database="+ MONGO_DB_DATABASE +"&collection="+ MONGO_DB_COLLECTION +"&operation=insert")
